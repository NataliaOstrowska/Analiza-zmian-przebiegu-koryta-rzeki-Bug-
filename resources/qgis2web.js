...
map.getView().fit([2346197.886513, 6884121.248292, 2414220.945352, 6918144.584227], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza przebiegu rzeki Bug NO</h2>';
        return titleElement;
    })(),
